package com.chula.agrisnap.ui.screens.livestock
...
@Composable
fun VegetableScreen(navController: NavController){
//Scaffold
            ...
            Column(
                ...
                Column (
                    ...
                    Row(
                        ...
                        listOf(
                            Triple("Spinach", R.drawable.sph, "ksh200.00/kg"),
                            Triple("Kale", R.drawable.kale, "ksh150.00/kg"),
                            Triple("Carrots", R.drawable.carr, "ksh220.00/kg")
                    ...
                    Row(
                        ...
                        listOf(
                            Triple("Cabbage", R.drawable.cabb, "ksh250.00/kg"),
                            Triple("Cauliflower", R.drawable.ca, "ksh350.00/kg"),
                            Triple("Onions", R.drawable.onio, "ksh200.00/kg")
                        ).forEach { (name, imageRes, price) ->
                            Card(
                                modifier = Modifier
                                    .width(110.dp)
                    ...
                    Row(
                        ...
                        listOf(
                            Triple("Potatoes", R.drawable.pot, "ksh200.00/kg"),
                            Triple("Beans", R.drawable.ben, "ksh100.00/kg"),
                            Triple("Beets", R.drawable.be, "ksh200.00/kg")
                        ).forEach { (name, imageRes, price) ->
                            Card(
                                modifier = Modifier
                                    .width(110.dp)
                    ...
                    Row(
                        ...
                        listOf(
                            Triple("Radishes", R.drawable.red, "ksh250.00/kg"),
                            Triple("Broccoli", R.drawable.bro, "ksh140.80/kg"),
                            Triple("Garlic", R.drawable.gar, "ksh100.00/kg")
                        ).forEach { (name, imageRes, price) ->
                            Card(
                                modifier = Modifier
                                    .width(110.dp)
