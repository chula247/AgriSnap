package com.chula.agrisnap.ui.screens.poultry
...
@Composable
fun PoultryScreen(navController: NavController){
//Scaffold
            ...
            Column(
                    ...
                    items(imageUrls) { imageUrl ->
                        Card(
                            ...
                            AsyncImage(
                                ...
                                placeholder = painterResource(R.drawable.pt),
                ...
                Column (
                    ...
                    Row(
                        ...
                        listOf(
                            Triple("Burgers", R.drawable.bar, "ksh400.00/kg"),
                            Triple("Sausages", R.drawable.sau, "ksh200.80/kg"),
                            Triple("Nuggets", R.drawable.nug, "ksh300.20/kg")
                    ...
                    Row(
                        ...
                        listOf(
                            Triple("Eggs", R.drawable.eggs, "ksh90.00/kg"),
                            Triple("Chicken meat", R.drawable.ch, "ksh400.80/kg"),
                            Triple("Duck meat", R.drawable.du, "ksh450.20/kg")
                        ).forEach { (name, imageRes, price) ->
                            Card(
                                modifier = Modifier
                                    .width(110.dp)
                    ...
                    Row(
                        ...
                        listOf(
                            Triple("chicks", R.drawable.chick, "ksh50.00/chick"),
                            Triple("Goose meat", R.drawable.gu, "ksh500.80/kg"),
                            Triple("Turkey meat", R.drawable.tu, "ksh600.20/kg")
                        ).forEach { (name, imageRes, price) ->
                            Card(
                                modifier = Modifier
                                    .width(110.dp)
                    ...
                    Row(
                        ...
                        listOf(
                            Triple("chicken", R.drawable.chik, "ksh500.00/bird"),
                            Triple("Turkey", R.drawable.tuk, "ksh4500.80/bird"),
                            Triple("Goose", R.drawable.guus, "ksh2500.20/bird")
                        ).forEach { (name, imageRes, price) ->
                            Card(
                                modifier = Modifier
                                    .width(110.dp)
                    ...
                    Text(
                        text = "✨ Best Value for Your Harvest ✨",
                        fontSize = 20.sp,
                        modifier = Modifier
                            .fillMaxWidth()
...
@Composable
fun PoultryScreenPreview(){
   PoultryScreen(navController= rememberNavController())
}