...
@Composable
fun DairyScreen(navController: NavController){
//Scaffold
            ...
            Column(
                    ...
                    items(imageUrls) { imageUrl ->
                        Card(
                            ...
                            AsyncImage(
                                ...
                                placeholder = painterResource(R.drawable.dairy),
                ...
                Column (
                    ...
                    Row(
                        ...
                        listOf(
                            Triple("Milk", R.drawable.mlk, "ksh70.00/litter"),
                            Triple("Butter", R.drawable.but, "ksh80.80/kg"),
                            Triple("Cream", R.drawable.cr, "ksh40.20/kg")
                    ...
                    Row(
                        ...
                        listOf(
                            Triple("Casein", R.drawable.pow, "ksh400.00/kg"),
                            Triple("Kefir", R.drawable.kef, "ksh100.80/kg"),
                            Triple("ButterMilk", R.drawable.butm, "ksh60.20/kg")
                        ).forEach { (name, imageRes, price) ->
                            Card(
                                modifier = Modifier
                                    .width(110.dp)
                    ...
                    Row(
                        ...
                        listOf(
                            Triple("Sour Cream", R.drawable.sure, "ksh150.00/kg"),
                            Triple("Dairy Cow", R.drawable.dry, "ksh100000.00/cow"),
                            Triple("Dairy Goats", R.drawable.goat, "ksh10000.20/goat")
                        ).forEach { (name, imageRes, price) ->
                            Card(
                                modifier = Modifier
                                    .width(110.dp)
                    ...
                    Row(
                        ...
                        listOf(
                            Triple("Cow Meat", R.drawable.meat, "ksh400.00/kg"),
                            Triple("Goat Meat", R.drawable.img_1, "ksh350.80/kg"),
                            Triple("Rabbit Meat", R.drawable.img_2, "ksh300.20/kg")
                        ).forEach { (name, imageRes, price) ->
                            Card(
                                modifier = Modifier
                                    .width(110.dp)
